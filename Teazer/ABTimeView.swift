...
open class ABTimeView: UIView {
    ...
    public init(size: CGSize, position: Int){
        ...
        self.timeLabel.font = UIFont(name: Constants.kProximaNovaSemibold, size: 12.0)
        self.timeLabel.frame = CGRect(x: marginLeft, y: marginTop, width: size.width - marginLeft,
                                      height: size.height - marginTop)
